...
const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ onPromptClick }) => {
  const prompts = [
    ...
    },
    {
      ...
      title: 'Write a poem',
      text: 'about the secret life of cats',
    },
  ];
  ...
  return (
    <div className="flex h-full flex-col items-center justify-center text-center p-4">
      <div className="mb-8">
        <CatIcon className="h-16 w-16 text-blue-500" />
      </div>
      <h1 className="text-4xl font-bold mb-4">Hello! I'm MAG.</h1>
      <p className="text-gray-500 dark:text-gray-400 mb-8">How can I help you today?</p>
